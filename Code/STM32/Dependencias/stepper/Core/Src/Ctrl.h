...
#define CTRL_TRIGGER_PASO1      3   // Entrada para el Trigger del paso 1
#define CTRL_TRIGGER_PASO2      3   // Entrada para el Trigger del paso 2
#define CTRL_TRIGGER_PASO3      3   // Entrada para el Trigger del paso 3
...
#define CTRL_MODO            0       // Modo Oneshot
#define CTRL_CANT_PASOS      3       // 3 pasos en modo continuo

#define CTRL_TIMEOUT_0       120       // segundos para el Trigger del oneshot
